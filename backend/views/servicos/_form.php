...
<header class="main_menu_area">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item"><a style=" font-size: 20px;" href="index.php?r=servicos%2Fcreate">Pagamento</a></li>
    ...
    <div class="container">
        ...
        <section class="static_area">
            <div class="container">
                ...
                <?= $form->field($model, 'incentivo')->textInput(['maxlength' => true]) ?>
                ...
                <div class="form-group">
                    <?= Html::submitButton($model->isNewRecord ? 'Pedir' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
                </div>
